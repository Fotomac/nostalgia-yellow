FishingSlots::
	...
	db CERULEAN_GYM,HORSEA,25,GOLDEEN,30,SHELLDER,35,GYARADOS,40
	...
	db SEAFOAM_ISLANDS_4,KRABBY,25,STARYU,20,KINGLER,35,STARMIE,40
	db SEAFOAM_ISLANDS_5,KRABBY,25,STARYU,20,KINGLER,35,STARMIE,40
